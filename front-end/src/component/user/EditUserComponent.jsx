...
saveUser = (e) => {
    ...
    .then( res => {
        this.setState({
            message: user.lastName+"님이 정보가 수정되었습니다."
        })
...
render(){
    return(
        ...
        <form>
         ...
         <TextField placeholder="Edit input your First name" name="firstName"
          fullWidth margin="normal" value={this.state.firstName} onChange={this.onChange}/>

          <TextField placeholder="Edit input your Last name" name="lastName"
